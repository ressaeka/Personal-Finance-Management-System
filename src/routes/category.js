...
import { createCategorySchema, updateCategorySchema, categoryIdSchema, categoryQuerySchema } from "../validators/category.js";

const router = express.Router();

router.post( "/", authenticate, validate(createCategorySchema), createCategory );
router.get( "/", authenticate, validate(categoryQuerySchema, "query"), getAllCategory );
