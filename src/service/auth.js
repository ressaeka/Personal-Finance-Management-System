...
export const registerService = async (userData) => {
    ...
    if (!STRONG_PASSWORD_REGEX.test(password)) {
        throw new AppError("Password harus minimal 8 karakter, mengandung huruf kecil, huruf besar, angka, dan simbol", 400);
    }
    ...
    // Destructuring untuk menghapus properti password sebelum data dikembalikan
