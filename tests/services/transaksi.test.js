...
describe('TRANSAKSI SERVICE TESTS', () => {
  ...
  describe('CREATE TRANSAKSI SERVICE', () => {
    describe('Validation Tests', () => {
      test('should throw error if id_user is missing', async () => {
        await expect(
          createTransaksiService(null, 1, 10000, 'Test', '2024-06-15'),
      ...
      test('should allow jumlah negative (converted by service)', async () => {
        ...
        const result = await createTransaksiService(
          1,
          1,
          -1000,
          'Test',
        ...
        expect(createTransaksi).toHaveBeenCalledWith(
          1,
          1,
          1000,
          'Test',
  ...
  describe('GET ALL TRANSAKSI SERVICE', () => {
    test('should throw error if id_user is missing', async () => {
      await expect(getAllTransaksiService(null)).rejects.toThrow(
        'User tidak valid',
      );
    });
  ...
  describe('GET TRANSAKSI BY ID SERVICE', () => {
    describe('Validation Tests', () => {
      test('should throw error if id_transaksi is missing', async () => {
        await expect(getTransaksiByIdService(null, 1)).rejects.toThrow(
          'ID transaksi tidak valid',
        );
      });

      test('should throw error if id_transaksi is not a number', async () => {
        await expect(getTransaksiByIdService('abc', 1)).rejects.toThrow(
          'ID transaksi tidak valid',
        );
      });

      test('should throw error if id_transaksi is negative', async () => {
        await expect(getTransaksiByIdService(-1, 1)).rejects.toThrow(
          'ID transaksi tidak valid',
        );
      });

      test('should throw error if id_user is missing', async () => {
        await expect(getTransaksiByIdService(1, null)).rejects.toThrow(
          'User tidak valid',
        );
      });
    });
    ...
    describe('Success and Not Found Tests', () => {
      ...
      test('should throw 404 if transaksi not found', async () => {
        ...
        await expect(getTransaksiByIdService(999, 1)).rejects.toThrow(
  ...
  describe('UPDATE TRANSAKSI SERVICE', () => {
    ...
    describe('Success Tests', () => {
      test('should update transaksi successfully', async () => {
        ...
        expect(updateTransaksi).toHaveBeenCalledWith(
          1,
          1,
          2,
          -75000,
  ...
  describe('DELETE TRANSAKSI SERVICE', () => {
    describe('Validation Tests', () => {
      test('should throw error if id_transaksi is missing', async () => {
        await expect(deleteTransaksiService(null, 1)).rejects.toThrow(
          'ID transaksi tidak valid',
        );
      });

      test('should throw error if id_transaksi is not a number', async () => {
        await expect(deleteTransaksiService('abc', 1)).rejects.toThrow(
          'ID transaksi tidak valid',
        );
      });

      test('should throw error if id_user is missing', async () => {
        await expect(deleteTransaksiService(1, null)).rejects.toThrow(
          'User tidak valid',
        );
      });
    });
    ...
    describe('Success and Not Found Tests', () => {
      ...
      test('should handle database error', async () => {
        ...
        await expect(deleteTransaksiService(1, 1)).rejects.toThrow(
          'Database error',
        );
      });
    });
